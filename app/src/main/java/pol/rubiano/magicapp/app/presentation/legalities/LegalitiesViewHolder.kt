...
class LegalitiesViewHolder(
    ...
    fun bind(format: String, legality: String) {
        ...
        if (legality == "legal") {
            (tvLegality.background as GradientDrawable).setColor(Color.parseColor("#CCFFCC"))
        } else if (legality == "not_legal") {
            (tvLegality.background as GradientDrawable).setColor(Color.parseColor("#FFCCCC"))
        } else {
            (tvLegality.background as GradientDrawable).setColor(Color.parseColor("#CCCCCC"))
        }
    }
}
